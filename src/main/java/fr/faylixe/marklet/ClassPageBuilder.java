...
public final class ClassPageBuilder extends MarkletDocumentBuilder {
   ...
   * @param createBadge add "generated by" badge to generated doc or not
   * @throws IOException If any error occurs while writing documentation
   */
  public static void build(
      final ClassDoc classDoc, final Path directoryPath, final boolean createBadge)
      throws IOException {
    final Path classPath =
        Paths.get(classDoc.simpleTypeName() + MarkdownDocumentBuilder.FILE_EXTENSION);
    ...
    builder.fields();
    builder.methods();
    builder.build(directoryPath.resolve(classPath), createBadge);
  }
}
