...
public class MarkdownDocumentBuilder {
   ...
   */
  private String filterParagraph(final String text) {
    return text.replace(PARAGRAPH_OPEN, "").replace(PARAGRAPH_CLOSE, "");
  }
  ...
  public final void italic(final String text) {
    buffer.append(ITALIC).append(text).append(ITALIC);
  }
