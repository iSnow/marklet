 ...
 * @author fv
 */
public final class OldPackagePage extends MarkletDocument {
   ...
   */
  private OldPackagePage(final PackageDoc packageDoc, final MarkletOptions options) {
  ...
  public static void build(
    ...
    final OldPackagePage packageBuilder = new OldPackagePage(packageDoc, options);
