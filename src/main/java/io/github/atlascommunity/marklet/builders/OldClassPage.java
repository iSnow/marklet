 ...
 * @author fv
 */
public final class OldClassPage extends MarkletDocument {
   ...
   */
  private OldClassPage(final ClassDoc classDoc, final MarkletOptions options) {
  ...
  public static void build(
    ...
    final OldClassPage builder = new OldClassPage(classDoc, options);
    builder.header();
    builder.summary();
